...
type StudentFreeTime struct {
	...
	UserID    uint64    `gorm:"column:user_id;not null;uniqueIndex:uk_term_student_time;index:idx_user_term" json:"user_id"`
...
type AttendanceCheck struct {
	...
	StartedByUserID uint64    `gorm:"column:started_by_user_id;not null;index:idx_started_by_time" json:"started_by_user_id"`
...
type AdminOperationLog struct {
	ID             uint64    `gorm:"column:id;primaryKey;autoIncrement" json:"id"`
	OperatorUserID uint64    `gorm:"column:operator_user_id;not null;index:idx_operator_time" json:"operator_user_id"`
